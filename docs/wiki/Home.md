...
| [Cost Projection Model](Cost-Projection-Model) | How costs are measured, scaled, and projected |
| [Architecture](Architecture) | Module structure, ADRs, design decisions |
| [Contributing](Contributing) | Build setup, test suite, how to add pricing data or framework support |
